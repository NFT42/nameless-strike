...
contract ExternalAuthSales is OwnableClone, RevenueSplit, SalesHistory {
  ...
  function purchase(
    ...
    require(currentListingIds.contains(listingId), 'No such listing'); // TODO: Remove for Sales API
    ...
    ); // TODO: Add authorized signers list to smart contract. Separate control for admin

    ISaleable(listing.tokenAddress).processSale(listing.offeringId, _recipient, price);
